...
public class OrganizerPanelActivty extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position) {
                case 0:
                    fragment = new OrganizerFragmentList();
                    break;
                case 1:
                    fragment = new OrganizerFragmentAddNew();
                    break;
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_organizer_panel_activty, container, false);
            return rootView;
        }
    }
